...
describe("Link versioned assets in versioned docs", function() {
    ...
    it("Should replace asset links in versioned docs", 
        async function() {
            mockUnlinkedMarkdownFiles();
            await linker.linkAssetsInMarkdownFiles(path.join(process.cwd(), "versioned_docs"), "1.4.5");
    ...
    it("Should not write to a file when it does not have links", 
        ...
        await linker.linkAssetsInMarkdownFiles(versionedDocsDir, "1.4.5");
